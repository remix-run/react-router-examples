...
Thanks for your willingness to contribute an example to React Router. Examples are incredibly helpful to people like you who are trying to figure out how to use React Router to solve certain problems and integrate with other tools.
...
1. Fork this repository (click the [Fork](https://github.com/remix-run/react-router-examples/fork) button at the top of this page)
...
4. Add your example
   ...
   To create an example, use `npx create-react-router` to scaffold an app. Make the changes you need for your example, update the `README.md`, make sure that it works and that you kept it focused (see above).
...
6. Head to the [react-router-examples repository](https://github.com/remix-run/react-router-examples), GitHub will prompt you to create a pull request against the repository.
